...
mit.main = function() {
  ...
  */
  ...
  tweet.href='http://twitter.com/share?url=http://www.chocomoonstudio.com/webapp/FluffyBird/index.html';

  var facebook = document.getElementById("fb");
  facebook.href='http://facebook.com/sharer.php?s=100&p[url]=http://www.chocomoonstudio.com/webapp/FluffyBird/index.html';
  ...
  */
  mit.gameOver = function() {
    ...
    // Share
    var tweet = document.getElementById("tweet");
    tweet.href='http://www.chocomoonstudio.com/webapp/FluffyBird' +Math.floor(mit.score)+ ' points in FluffyBird!';
  
    var facebook = document.getElementById("fb");
    facebook.href='http://www.chocomoonstudio.com/webapp/FluffyBird/index.html' +Math.floor(mit.score)+ ' points in the FluffyBird!';
